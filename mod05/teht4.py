...
# väliltä 1..10. Kone arvuuttelee lukua pelaajalta
# siihen asti, kunnes tämä arvaa oikein. Kunkin arvauksen
# jälkeen ohjelma tulostaa tekstin Liian suuri arvaus,
# Liian pieni arvaus tai Oikein. Huomaa, että tietokone
